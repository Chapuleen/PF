...
<?PHP
  ...
  if(!isset($_SESSION['sess_user'])){
    ...
    $valido = true;
    $borrar=mysqli_query($con,"SELECT p.idproducto, p.cantidad, up.cantidad FROM producto p, usupro up WHERE p.idproducto=up.idproducto AND mail='{$_SESSION['sess_user']}' AND pagado=0;");
    ...
    if($valido == true){
      ...
      while($fila = mysqli_fetch_array($ejecutar)){
        ...
        mysqli_query($con,"UPDATE producto SET p_cantidad=$stock WHERE id_producto={$fila['idproducto']}");
      }
