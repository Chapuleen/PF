		...
		<div class="container">
			<div class="row">
					...
					<div class="login_form_inner">
						...
						<form class="row login_form"  method="post" id="contactForm" novalidate="novalidate">
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="nombreUsuario" name="user" placeholder="Username" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Username'">
							</div>
							<div class="col-md-12 form-group">
              ...
              if(!empty($_POST['user']) && !empty($_POST['pass'])){
                ...
                //Selecting Database
                $statement = "SELECT * FROM usuario WHERE mail='$user' AND password='$pass'";
                ...
                if($numrows !=0){
                  ...
                  if($user == $dbusername && $pass == $dbpassword){
                     $_SESSION['sess_user']=$user;
										 ...
										 if($user = 'Eduardo'){
		 											 echo '<meta http-equiv="refresh" content="0; URL=http://localhost/atom/PF/admin.php">';
